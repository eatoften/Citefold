...
claim scope, and no-overwrite persisted freeze authority. G0.2b now publishes
and independently replays the fixed 68-page Lecture 3 parser/chunker output,
...
- [x] repeat that journey with the hash-pinned CS336 Lecture 3 Source: 68 page
  Chunks, a two-hop engineering-fixture Trace, page 65/66 evidence, and three
